...
export function TradeLog({ transactions }: TradeLogProps) {
  ...
  return (
    <div className="border-4 border-gray-300 bg-black text-white">
      {/* Header */}
      <div className="border-b-4 border-gray-300 p-4 bg-black text-white">
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-left text-sm">
          <thead className="border-b-4 border-gray-300 bg-black">
            <tr>
          ...
          <tbody>
            {transactions.length === 0 ? (
              <tr>
                <td colSpan={9} className="p-8 text-center text-gray-300">
              ...
              transactions.map((tx, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="p-3">
                      <span
                        className={`px-2 py-1 border-2 border-gray-300 font-black text-xs ${
                    ...
                    <td className="p-3 text-center">
                      {tx.isOverdrive && (
                        <span className="bg-red-600 text-white px-2 py-1 text-xs font-black border-2 border-gray-300 glitch-text">
                          [GLITCH]
                        </span>
                      )}
                    </td>
      ...
      {/* Footer Stats */}
      {transactions.length > 0 && (
        <div className="border-t-4 border-gray-300 p-4 bg-black">
          <div className="grid grid-cols-3 gap-4 text-center">
            ...
            <div>
              <div className="text-xs font-bold text-gray-300">WIN RATE</div>
